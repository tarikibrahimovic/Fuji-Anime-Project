...
function Profile() {
  ...
  let status;
  const { token, setIsAuth, setUsername, username, id, email, verifiedAt, admin, isAuth } = useContext(FavoritesList);
  ...
  return (
    <>{isAuth ? (<div className="bg-dark p-5 h-full w-full">
    <div className="flex justify-center mb-6 border-b border-logored pb-4">
      ...
      <BsArrowLeft className="text-white text-3xl m-5 cursor-pointer" onClick={(e) => {
          e.preventDefault()
          navigate('/layout/home', {})
      }}/>
